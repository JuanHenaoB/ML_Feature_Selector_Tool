...
if __name__ == '__main__':
    ...
    print(" This means that the maximum ampount of votes one feature can get is 6")
    ...
    top_feats = int(input("\nPlease input the number of top voted m features \n"))
    print("\n")
    ...
    print("\n top "+str(top_feats)+" voted features are: \n", best_voted_features)